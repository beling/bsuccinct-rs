...
///
/// It must be initialized by non-zero seed, never generates zero, and its period is 2^32-1.
///
...
///
/// It must be initialized by non-zero seed, never generates zero, and its period is 2^64-1.
///
/// The algorithm is described in:
/// - George Marsaglia, "Xorshift RNGs", Journal of Statistical Software, 2003, 8(14), 1–6.
///   <https://doi.org/10.18637/jss.v008.i14>
