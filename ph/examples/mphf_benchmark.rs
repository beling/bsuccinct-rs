...
fn test_data<I: Iterator>(how_many: usize, mut generator: I) -> (Vec<I::Item>, Vec<I::Item>) {
    (generator.by_ref().take(how_many).collect(), generator.take(1_000_000).collect())
}

//fn test_data_32(how_many: usize) -> (Vec<u32>, Vec<u32>) { test_data(how_many, XorShift32(1234)) }
fn test_data_64(how_many: usize) -> (Vec<u64>, Vec<u64>) { test_data(how_many, XorShift64(1234)) }
...
where K: Hash
{
    ...
    for lambda in 1..=6 {
        ...
        println!("{} {} {} {}", lambda, b.bits_per_value, b.build_process_time_seconds, b.included.avg_lookup_time);
    }
}
