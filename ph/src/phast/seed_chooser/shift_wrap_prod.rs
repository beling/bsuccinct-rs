...
fn shift_only_wrapped_bucket_evaluator_m1(bits_per_seed: u8, slice_len: u16) -> [i32; 7] {
    if WINDOW_SIZE > 350 {
        match (bits_per_seed, slice_len) { // WINDOW_SIZE = 512
            ...
            (..=6, ..=256) => [-76632, 59701, 89939, 103115, 111040, 117906, 283652], // W=512, S=6, 3.0, slice=256
            (..=6, ..=512) => [-102171, 30195, 95877, 122987, 138980, 152173, 206055],  // W=512, S=6, 3.0, slice=512
            (_, ..=256) => [-84425, 81165, 96951, 106065, 112137, 117421, 122309],  // W=512, S=7, 3.5, slice=256
            (7, ..=512) => [0, 133072, 174719, 193093, 205992, 215339, 222230],  // W=512, S=7, 3.5, slice=512, 4.03%
