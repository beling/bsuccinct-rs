...
#[inline(always)]
fn best_seed_k<SC: SeedChooser, C: Core>(k: u8, seed_chooser: SC, best_value: &mut usize, best_seed: &mut u16, used_values: &mut UsedValueMultiSetU8, keys: &[u64], conf: &C, seeds_num: u16) {
