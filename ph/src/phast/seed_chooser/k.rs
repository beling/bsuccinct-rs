...
const PROD_S8_L512: [(u16, [i32; 7], ProdOfValuesKEval); 3] = [   // for W=512
    ...
    (8, [0, 168706, 220511, 228023, 229920, 231938, 232206], P{value_shift: 0.00352, free_shift: 1.29204, first_weight: 0.81172}), //O0.73%
    (16, [0, 150606, 171755, 186904, 190381, 195153, 195172], P{value_shift: 0.00353, free_shift: 1.48532, first_weight: 0.81982}) //O0.14%
];
#[cfg(not(feature = "W256"))]
const PROD_S8_L1024: [(u16, [i32; 7], ProdOfValuesKEval); 35] = [   // for W=512
    (2, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{ value_shift: 0.00471, free_shift: 1.65874, first_weight: 0.12367 }), // O1.01%
    (3, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00381, free_shift: 1.80743, first_weight: 0.20054 }), // O1.07%
    (4, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00559, free_shift: 1.85542, first_weight: 0.29544}), // O1.02%
    (5, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00396, free_shift: 2.35814, first_weight: 0.62478 }), // O1.04%
    (6, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00351, free_shift: 2.64993, first_weight: 0.74814 }), // O0.96%
    ...
    (16, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00312, free_shift: 3.66667, first_weight: 0.68020 }), // O0.54%
