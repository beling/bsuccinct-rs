...
const PROD_S8_L512: [(u16, [i32; 7], ProdOfValuesKEval); 4] = [   // for W=512
    ...
    (8, [0, 163253, 202749, 216108, 219736, 223459, 223804], P{value_shift: 0.00364, free_shift: 1.21310, first_weight: 0.85404}), // 0.92% for λ=18.28
...
const PROD_S8_L1024: [(u16, [i32; 7], ProdOfValuesKEval); 35] = [   // for W=512
    (2, [0, 128493, 183625, 213859, 234965, 251661, 261834], P{value_shift: 0.00496, free_shift: 1.58930, first_weight: 0.10560}), // O1.00%
