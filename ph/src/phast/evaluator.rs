        ...
        if WINDOW_SIZE > 350 {
            Self(if slice_len <= 256 {  // this is used only for small number of keys
                ...
                match (bits_per_seed, slice_len) {
                    ...
                    (..=8, ..=2048) => [-2419, 19625, 137589, 195995, 232036, 261678, 281232], // 8, 4.4, 2048, W=512, 0.79%
                    (..=8, _) => [-844, -5846, 162821, 234092, 295908, 333728, 366433], // 8, 4.4, 4096, W=512, 0.83%
                    // [-894, -5871, 164268, 264432, 348426, 406150, 447081], // 8, 4.4, 4096, W=512, 0.82% WRONG
