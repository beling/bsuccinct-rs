    ...
    pub fn new(bits_per_seed: u8, slice_len: u16) -> Self {
        Self(if slice_len <= 256 {  // this is used only for small number of keys
            ...
            match (bits_per_seed, slice_len) {
                ...
                (8, ..=1024) => [-51774, 74183, 128085, 157456, 179060, 196306, 206203],    // 4.4, W=512
                (..=8, _) => [-2419, 19625, 137589, 195995, 232036, 261678, 281232], // 8, 4.3, 2048, W=512, 0.79%
                ...
                (_, _) => [2945, 13340, 219515, 311622, 397987, 434376, 459408] // 11, 6.5, 4096, W=512, 0.88%
            }
