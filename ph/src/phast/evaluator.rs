...
impl Weights {
    pub fn new(bits_per_seed: u8, slice_len: u16) -> Self {
        Self(match (bits_per_seed, slice_len) {
            ...
            (8, _) => [-50257, 59473, 109815, 141892, 163422, 181047, 192876],    //4.3
                //[-50780, 60088, 108883, 141658, 163733, 181378, 192988]
            ...
            (10, _) => [-66184, 64417, 120321, 146569, 163302, 179408, 185470],   //5.9
            (_, 0..=512) => [-64904, 67974, 141210, 154142, 162631, 171673, 174504],    //6.5
            (_, _) => [-64909, 65736, 120849, 146418, 164214, 179734, 184733], //6.5
        })
    }
}
