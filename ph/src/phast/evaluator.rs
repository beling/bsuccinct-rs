        ...
        if WINDOW_SIZE > 350 {
            Self(if slice_len <= 256 {  // this is used only for small number of keys
                ...
                match (bits_per_seed, slice_len) {
                    ...
                    (8, ..=1024) => [-52055, 76425, 131372, 161825, 182914, 199476, 209672],    // 8, 4.4, 1024, W=512, 0.80%
                    (..=8, ..=2048) => [8711, 174677, 277200, 349724, 373821, 407568, 433024], // 8, 4.4, 2048, W=512, 0.69% !!!
                    ...
                    (9, ..=2048) => [-2341, 15197, 143019, 208073, 245150, 269831, 282233],  // 9, 5.3, 2048, W=512
                    ...
                    (10, _) => [3068, 14363, 220816, 313457, 383261, 431200, 462090], // 10, 5.9, 4096, W=512, 1.13%
