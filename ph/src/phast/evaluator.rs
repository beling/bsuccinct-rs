    ...
    pub fn new(bits_per_seed: u8, slice_len: u16) -> Self {
        Self(if slice_len <= 256 {  // this is used only for small number of keys
            ...
            match (bits_per_seed, slice_len) {
                ...
                (9, _) => [-2341, 15197, 143019, 208073, 245150, 269831, 282233],  // 9, 5.3, 2048, W=512 (much better than before W=512 opt.)
                ...
                (10, _) => [-2383, 11093, 124723, 185117, 221925, 245415, 255824], // 10, 5.9, 2048, W=512
