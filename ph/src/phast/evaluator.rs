...
impl Weights {
    pub fn new(bits_per_seed: u8, slice_len: u16) -> Self {
        Self(match (bits_per_seed, slice_len) {
            (_, ..=128) => [-63959, 115754, 122726, 127490, 130308, 132899, 134355],    // 8, 4.3, TODO more iters
            (_, ..=256) => [-71870, 103524, 117535, 125971, 132173, 136976, 139813],    // 8, 4.3, TODO more iters
            (..=4, ..=512) => [-126969, 15686, 67995, 99429, 116711, 218955, 233075], // 2.5
            (..=4, _) => [-67844, 12942, 103312, 155604, 191240, 199105, 203210],  // 2.5
            (5, ..=512) => [-125171, 31908, 74770, 100065, 115115, 126729, 164878],    // 2.9
            (5, ..=1024) => [-61359, 22918, 98732, 144970, 180112, 206496, 225555],    // 2.9
