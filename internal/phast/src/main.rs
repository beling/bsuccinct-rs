...
use ph::phast::{ProdOfValues, ProdOfValuesTurbo, SeedOnly, SeedOnlyK, ShiftOnly, ShiftOnlyWrapped, SumOfValuesTurbo, space_lower_bound};
...
fn main() {
    ...
    match (conf.method, conf.k, conf.bits_per_seed, conf.one, bucket_size.into(), conf.is_turbo()) {
        (Method::phast, 1, 8, false, _, true) => conf.run(|keys| phast(keys, conf.params_turbo(), threads_num, SeedOnly(SumOfValuesTurbo))),
        (Method::phast|Method::phast2|Method::perfect, 1, 8, true, _, true) => conf.runp(|keys| partial(keys, conf.params_turbo(), threads_num, SeedOnly(SumOfValuesTurbo))),
        ...
        (Method::phast, k, 8, false, _, true) => conf.run(|keys| kphast(keys, conf.params_turbo(), threads_num, SeedOnlyK::with_evaluator(k, ProdOfValues))),
        ...
        (Method::phast2, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, SeedOnly(ProdOfValues))),
        ...
        (Method::pluswrap { multiplier: 3 }, 1, 8, false, _, true) => conf.run(|keys| phast(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<3>)),
        (Method::pluswrap { multiplier: 5 }, 1, 8, false, _, true) => conf.run(|keys| phast(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<5>)),
        (Method::pluswrap { multiplier: 7 }, 1, 8, false, _, true) => conf.run(|keys| phast(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<7>)),
        ...
        (Method::pluswrap2 { multiplier: 1 }, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<1>)),
        (Method::pluswrap2 { multiplier: 2 }, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<2>)),
        (Method::pluswrap2 { multiplier: 3 }, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<3>)),
        (Method::pluswrap2 { multiplier: 5 }, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<5>)),
        (Method::pluswrap2 { multiplier: 7 }, 1, 8, false, _, true) => conf.run(|keys| phast2(keys, conf.params_turbo(), threads_num, ShiftOnlyWrapped::<7>)),
