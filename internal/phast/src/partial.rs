use ph::{phast::{Conf, Core, Partial, SeedChooser, SeedChooserCore}, seeds::SeedSize};
...
pub fn partial<P: Conf, SC: SeedChooser>(keys: &[u64], params: P, threads_num: usize, seed_chooser: SC) -> Partial<P::Core, P::SeedSize, SC::Core, ()>
{
