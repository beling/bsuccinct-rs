use ph::{phast::{ConfTrait, DefaultCompressedArray, Params, ParamsTrait, SeedChooser}, seeds::SeedSize};
...
pub fn phast2<SS: SeedSize, SC: SeedChooser>(keys: &[u64], params: Params<SS>, threads_num: usize, seed_chooser: SC) -> ph::phast::Function2<SS, SC, DefaultCompressedArray, Hasher>
{
