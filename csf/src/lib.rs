...
//! - Functions with ***equal*** distribution map *2<sup>20</sup> = ed+i* arguments to *d+1* different values,
//!   where *d=1,...,255* and *i=1,...,e*.
//!   One value is assigned to *i* arguments, and each of the other *d* values is assigned to *e* arguments.
...
//!   where *k=1,...,4096*. The entropy of the distribution of function values increases with *k*.
//! 
//! The data for the plots are generated by the [csf_benchmark](https://crates.io/crates/csf_benchmark) program.
#![doc=include_str!("../plots/equal1.svg")]
#![doc=include_str!("../plots/equal2.svg")]
#![doc=include_str!("../plots/domin1.svg")]
#![doc=include_str!("../plots/domin2.svg")]
